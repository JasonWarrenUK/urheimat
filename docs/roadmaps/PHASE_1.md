...
- [x] **3PL.2**: Wire Auth.js with a GitHub OAuth app and enforce document ownership in the server routes
...
- [ ] **3PL.4**: Leaderboard of finished runs
...
graph LR
	...
	5RC.3 --> M5
	5RC.4 --> M5
	class 2DS.1,3PL.4,3PL.5 todo
	class 2DS.2,3PL.3,4SD.1,4SD.10,4SD.2,4SD.3,4SD.4,4SD.5,4SD.6,4SD.7,4SD.8,4SD.9,5RC.1,5RC.2,5RC.3,5RC.4 blocked
